...
function! s:GitGrepPopupRun(searchTerm)
    ...
    if exists('*popup_menu')
        ...
        " TODO: https://github.com/kamykn/popup-menu.nvim this might be
        " dependency that's needed.
        call popup_menu#open(prettyOutput, {
                    \ callback: {selected -> Cb(output, -1, selected)},
                    \ }, {
                    \ pos: "center",
                    \ maxheight: windowHeightSize,
                    \ minwidth: windowWidthSize,
